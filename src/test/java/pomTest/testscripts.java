...
public class testscripts {
    ...
    String username = "your_username"; // Replace with test data
    String password = "your_password"; // Replace with test data
    ...
    public void DeleteRepo() {
        ...
        Assert.assertFalse(driver.getCurrentUrl().contains(repoName), "Repository deletion failed.");
    }
