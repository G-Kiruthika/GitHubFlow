...
public class testscripts {
    ...
    String repoName = "selenium-automation-demo-repo"; // Replace with test data
    String repoFullName = "testuser/selenium-automation-demo-repo"; // Replace with test data
    ...
    public void RepoCreation() {
        ...
        Assert.assertTrue(driver.getCurrentUrl().contains(repoName), "Repository creation failed or did not navigate to repo page.");
    }
    ...
    public void DeleteRepo() {
        ...
        Assert.assertTrue(driver.getCurrentUrl().contains("/repositories"), "Repository deletion failed or did not redirect to repositories list.");
    }
    ...
    public void SignOut() {
        ...
        Assert.assertTrue(driver.getTitle().contains("Sign in"), "Sign out failed or did not redirect to sign-in page.");
    }
