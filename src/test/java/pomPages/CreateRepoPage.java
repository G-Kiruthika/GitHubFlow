...
public class CreateRepoPage {
    ...
    public boolean isRepoCreationErrorDisplayed() {
        try {
            WebElement error = driver.findElement(org.openqa.selenium.By.xpath("//auto-check//dl[@class='mb-0']//div[contains(@class,'error')]"));
